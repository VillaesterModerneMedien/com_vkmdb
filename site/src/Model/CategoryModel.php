...
class CategoryModel extends ListModel
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$search = $app->getUserStateFromRequest('com_vkmdb.category.list.' . $itemid . '.filter-search', 'filter-search', '', 'string');
		...
		if ((!$user->authorise('core.edit.state', 'com_vkmdb')) && (!$user->authorise('core.edit', 'com_vkmdb')))
		{
