...
namespace VkmdbNamespace\Component\Vkmdb\Site\Rule;
...
/**
 * FormRule for com_vkmdb to make sure the message body contains no banned word.
 *
 * @since  1.6
 */
class VkmdbCommentRule extends FormRule
{
	/**
