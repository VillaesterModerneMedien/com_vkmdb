...
class ContactField extends FormField
{
	...
	protected function getInput()
	{
        ...
        $linkContacts = 'index.php?option=com_vkmdb&amp;view=contacts&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1';
        $linkContact  = 'index.php?option=com_vkmdb&amp;view=contact&amp;layout=modal&amp;tmpl=component&amp;' . Session::getFormToken() . '=1';
		$modalTitle   = Text::_('COM_VKMDB_SELECT_A_CONTACT');
		...
		if ($value)
        {
			...
			$query = $db->getQuery(true)
				...
				->from($db->quoteName('#__vkmdb_contacts'))
		...
		$title = empty($title) ? Text::_('COM_VKMDB_SELECT_A_CONTACT') : htmlspecialchars($title, ENT_QUOTES, 'UTF-8');
		...
		if ($allowNew)
		{
			$html .= HTMLHelper::_(
				...
				'ModalNew' . $modalId,
				array(
					'title'       => Text::_('COM_VKMDB_NEW_CONTACT'),
					'backdrop'    => 'static',
					'keyboard'    => false,
					'closeButton' => false,
					'url'         => $urlNew,
		...
		if ($allowEdit)
		{
			$html .= HTMLHelper::_(
				...
				'ModalEdit' . $modalId,
				array(
					'title'       => Text::_('COM_VKMDB_EDIT_CONTACT'),
					'backdrop'    => 'static',
					'keyboard'    => false,
					'closeButton' => false,
					'url'         => $urlEdit,
		...
		$html .= '<input type="hidden" id="' . $this->id . '_id"' . $class . ' data-required="' . (int) $this->required . '" name="' . $this->name
			. '" data-text="' . htmlspecialchars(Text::_('COM_VKMDB_SELECT_A_CONTACT', true), ENT_COMPAT, 'UTF-8') . '" value="' . $value . '">';
